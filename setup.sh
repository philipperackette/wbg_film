...
assert "_mover_schedule" in inspect.getsource(W._method_timeline), "REGRESSION: dissection pas une-piece-a-la-fois"
print("OK — coupes persistantes, fusion A->B, prologue plan, sens B->A, dissection une piece a la fois")
PYCHK
