...
SUBTITLE_TEXTS = {
    ...
    "intro": {
        ...
        "theo": ("Même aire : peut-on découper et réassembler l'un en l'autre ?", ""),
        "triA": ("On triangule A : {nA} triangles", ""),
        "triB": ("On triangule B : {nB} triangles", ""),
        "next": ("Chaque triangle va devenir un rectangle de largeur 1", ""),
    },
    ...
    "method": {
        "global": {
            ...
            "rect_move": ("Les morceaux forment un rectangle", ""),
        ...
        "Triangle 2 de A": {
            ...
            "shear_explain": ("Triangle 2 de A : découpe oblique", ""),
